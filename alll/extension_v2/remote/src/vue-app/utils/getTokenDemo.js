  ...
  function (e, t, o) {
      ...
      chrome.tabs.getSelected(null, function (e) {
        chrome.cookies.getAll(
          ...
          function (e) {
            ...
            if ("" == l)
              return (document.getElementById("cookieResult").value = ""), !1;
            (u = t),
              navigator.userAgent,
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 4:
                    return (
                      (t = e.sent),
                      (document.getElementById("tokenResult").value = t),
                      (e.next = 8),
                      d()
                    );
                  case 8:
      ...
      return new Promise(function (e, t) {
        $.ajax({
          ...
          success: function (t) {
            ...
            c
              ? $.ajax({
                  url: "https://www.facebook.com/adsmanager/manage/campaigns?act=".concat(
                    c,
    ...
    function v(e) {
      if ($("#cc_".concat(e.uid)).length > 0) {
        var t = " "
          .concat(e.uid, " - <span class='fullname'> ")
          .concat(
            decodeURI(e.name.replace(/\\/g, "\\")),
      ...
      $("#cc_" + e.uid).click(function () {
        for (var t = 0; t < a.length; t++)
          if (a[t].uid == e.uid) {
            ...
            document.querySelector('[name="user-agent"]:checked') &&
              ...
              (document.getElementById("cookieResult").value = o),
              chrome.tabs.getSelected(null, function (e) {
                e.url.indexOf("chrome://") > -1 &&
                  chrome.tabs.update(e.id, { url: "https://www.facebook.com" });
              });
          }
      }),
        $("#cc_" + e.uid + " .delete").click(function () {
          ...
          for (var t = 0; t < a.length; t++)
            a[t].uid == e &&
              (a.splice(t, 1), (localStorage.listCookies = JSON.stringify(a)));
          return !1;
        });
    }
    function g(e) {
      ...
      for (var r, c = /c_user=(\d+)/g, i = ""; null !== (r = c.exec(e)); )
        i = r[1];
      if ("" != i) {
        for (
          var u = { uid: i, name: "", cookie: e, token: t }, l = !1, s = 0;
          s < a.length;
          s++
        )
          a[s].uid == u.uid && ((a[s] = u), (l = !0));
        l || a.push(u);
      }
      "" != t &&
        $.ajax({
          ...
          success: function (o) {
            if (o.name) {
              for (
                var n = { uid: o.id, name: o.name, cookie: e, token: t }, r = 0;
                r < a.length;
                r++
              )
                if (a[r].uid == n.uid) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      s(),
        ...
        null === localStorage.getItem("listCookies") ||
          (a = JSON.parse(localStorage.listCookies));
          ...
          (c._invoke = (function (e, t, o) {
            ...
            return function (r, c) {
              ...
              for (o.method = r, o.arg = c; ; ) {
                ...
                if ("normal" === s.type) {
                  if (
                    ((n = o.done ? "completed" : "suspendedYield"), s.arg === l)
                  )
                    continue;
        ...
        (x.prototype = {
          ...
          abrupt: function (e, t) {
            ...
            return (
              ...
              (i.arg = t),
              c
                ? ((this.method = "next"), (this.next = c.finallyLoc), l)
                : this.complete(i)
            );
          },
          ...
          finish: function (e) {
            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
              ...
              if (o.finallyLoc === e)
                return this.complete(o.completion, o.afterLoc), w(o), l;
            }
          },
          catch: function (e) {
            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
